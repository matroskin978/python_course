...
# search_entry.bind("<Return>", funcs.get_weather)
search_entry.bind("<Return>", command=lambda event: funcs.get_weather(elements=window_elements))

search_btn = ctk.CTkButton(top_frame, text="Search", width=100, command=lambda: funcs.get_weather(elements=window_elements))
